...
==================================================================== 
 ...
 PAGES:
 	<script src="https://dl.dropbox.com/u/1345573/themeCaddy/themeCaddy.min.js"></script>
...
var ThemeCaddy = {
	...
	Elements: {
		...
		mainNavGradient:	'#wrapNav .gradient',
	...
	Methods: {
		...
		storeElementStyles: function(o) {
			//console.log("storeElementStyles();");
			...
			$('.elementWrap').each(function() {
				...
				if (typeof o != "undefined") {
					if (typeof o.find('.elements').val() != "undefined") {
						...
						//console.log("Styles Stored: ",$(o).find('input[id^="storage"]').val());
					}
				}
			});
		...
		writeNewStyles: function() {
			...
			//console.log("Save Styles: ",newStyles);
		...
		initEmailHtmlViewer: function() {
			...
			$('#EmailContentViewer ul.emailContentMenu li a').click(function() {
				$('#EmailContentViewer ul.emailContentMenu li').removeClass('selected');
			...
			$('#showEventRegClassic').click(function() {
				ThemeCaddy.Methods.fetchEmailContent('Event Registration Confirmation Classic','#eventClassicContent');
				return false;
			});
		...
		fetchEmailContent: function(subject,selector) {
			...
			var emailHtml = $('#EmailContentCompiler').html();
			$('#EmailContentPane').text(emailHtml);
		}
	}
};
